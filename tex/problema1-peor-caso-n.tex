...
\begingroup
  ...
  \begin{picture}(9118.00,4320.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4808,4019){\makebox(0,0){\strut{}Peor caso ($n$)}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(2300,3556){\makebox(0,0)[r]{\strut{}$t_n / log(n)$}}%
      \csname LTb\endcsname%
      \put(2300,3356){\makebox(0,0)[r]{\strut{}$n$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{problema1-peor-caso-n}}%
    \gplfronttext
  \end{picture}%
\endgroup

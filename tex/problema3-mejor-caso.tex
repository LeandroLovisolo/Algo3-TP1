...
\begingroup
  ...
  \begin{picture}(7678.00,5280.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(2238,440){\makebox(0,0){\strut{}63x63,}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(3855,440){\makebox(0,0){\strut{}126x125,}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(5473,440){\makebox(0,0){\strut{}188x188,}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(7078,440){\makebox(0,0){\strut{}250x250,}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(160,2659){\rotatebox{90}{\makebox(0,0){\strut{}Tiempo de ejecuci\'on [$mS$]}}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(3849,140){\makebox(0,0){\strut{}$n$ (tama\~no del problema)}}%
      \csname LTb\endcsname%
      \put(3849,4979){\makebox(0,0){\strut{}Mejor caso}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(980,4516){\makebox(0,0)[r]{\strut{}$t_n$}}%
    }%
    \gplbacktext

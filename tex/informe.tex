...
Representamos un piso $P$ como una matriz de $m$ filas por $n$ columnas, donde cada coordenada puede tener uno de los siguientes valores: \texttt{Libre}, \texttt{Sensado}, \texttt{Importante}, \texttt{Pared}, \texttt{SensorVertical}, \texttt{SensorHorizontal}, \texttt{SensorCuadruple}.
...
\begin{enumerate}
    ...
    \item{
        ...
        Para cada uno de los pisos que no fue descartado en el paso anterior:
        \begin{enumerate}
            \item{
            ...
            \item{
                Si es solución y no se había hallado otra solución hasta el momento, o si es más barata que la mejor solución hallada hasta el momento, lo marcamos como mejor solución.
            }
        \end{enumerate}
    }
    \item{

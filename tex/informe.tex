...
\item Entrada con solución única, verifica que encuentra soluciones únicas correctamente. Por ejemplo, un piso cuadrado de 2x2 donde tres casilleros son pared.
\item Entrada con soluciones múltiples, verifica que el algoritmo elija la solución óptima de las posibles. Utilizamos como ejemplo el ejemplo del enunciado.
\end{enumerate}

...
\subsection{Solucion}
Dado que la solución está implementada con el método de backtracking, ideamos las siguientes podas para mejorar el tiempo de ejecución de este.
\begin{itemize}
	\item Si existe una solución anterior, podar los caminos que lleven a una solución de mayor costo.
	\item Para cada sensor, verificar que este no esté siendo sensado por otro sensor, ni que el sensor esté sensando a otro.
	\item Para cada casillero que esté libre o sea importante, verificar si estos estan siendo sensados. Si no estan siendo sensados, verificar si es posible colocar un nuevo sensor que los sense correctamente.
\end{itemize}

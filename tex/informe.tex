...
\begin{itemize}
    \item{
        ...
        \begin{itemize}
            ...
            \item{
                Si no es sensor cúadruple, podamos si produce que una posición libre en su misma fila o columna sea imposible de sensar.
    ...
    \item{
        ...
        Es decir, si no existe otra posición libre en su misma fila o columna sin pared entre ambas tal que se pueda poner un sensor apuntando a esta, sin qu su sedñal impacte otros sensores o viceversa.
    }
\end{itemize}

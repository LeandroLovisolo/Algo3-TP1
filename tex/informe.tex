...
\begin{figure}[H]
  \centering
  \include{problema1-peor-caso}
  \caption{Peor caso}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema1-peor-caso-logn}
  \caption{Peor caso ($log(n)$)}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema1-peor-caso-n}
  \caption{Peor caso ($n$)}
\end{figure}
...
\begin{figure}[H]
  \centering
  \include{problema1-mejor-caso}
  \caption{Mejor caso}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema1-mejor-caso-logn}
  \caption{Mejor caso ($log(n)$)}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema1-mejor-caso-n}
...
\begin{figure}[H]
  \centering
  \include{problema1-caso-promedio}
  \caption{Caso promedio}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema1-caso-promedio-logn}
  \caption{Caso promedio ($log(n)$)}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema1-caso-promedio-n}
  \caption{Caso promedio ($n$)}
\end{figure}
...
\begin{figure}[H]
  \centering
  \include{problema2-peor-caso}
  \caption{Peor caso}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema2-peor-caso-logn}
  \caption{Peor caso ($log(n)$)}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema2-peor-caso-n}
  \caption{Peor caso ($n$)}
\end{figure}
...
\begin{figure}[H]
  \centering
  \include{problema2-mejor-caso}
  \caption{Mejor caso}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema2-mejor-caso-logn}
  \caption{Mejor caso ($log(n)$)}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema2-mejor-caso-n}
  \caption{Mejor caso ($n$)}
\end{figure}
...
\begin{figure}[H]
  \centering
  \include{problema2-caso-promedio}
  \caption{Caso promedio}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema2-caso-promedio-logn}
  \caption{Caso promedio ($log(n)$)}
\end{figure}

\begin{figure}[H]
  \centering
  \include{problema2-caso-promedio-n}
  \caption{Caso promedio ($n$)}
\end{figure}
...
\begin{figure}[H]
  \centering
  \include{problema3-caso-promedio}
  \caption{Caso promedio}
\end{figure}

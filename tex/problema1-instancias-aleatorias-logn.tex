...
\begingroup
  ...
  \begin{picture}(9118.00,4320.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(160,2179){\rotatebox{90}{\makebox(0,0){\strut{}Tiempo de ejecuci\'on [$\mu S$]}}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(4748,140){\makebox(0,0){\strut{}$n$ (tama\~no del problema)}}%
      \csname LTb\endcsname%
      \put(4748,4019){\makebox(0,0){\strut{}Instancias aleatorias ($log(n)$)}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(1580,3556){\makebox(0,0)[r]{\strut{}$t_n / n$}}%
      \csname LTb\endcsname%
      \put(1580,3356){\makebox(0,0)[r]{\strut{}$log(n)$}}%
    }%
    \gplbacktext
